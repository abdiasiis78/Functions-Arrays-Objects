...
// Example 2 for loop:
  ...
  const arr = [{ id: 12, car_make: "Lotus", car_model: "Esprit", car_year: 2004 },
 { id: 13, car_make: "Chevrolet", car_model: "Cavalier", car_year: 1997 },
  { id: 14, car_make: "Dodge", car_model: "Ram Van 1500", car_year: 1999 },
  { id: 15, car_make: "Dodge", car_model: "Intrepid", car_year: 2000 },];
  const evens = [];
for (let i = 0; i < arr.length; i++) {
 if (arr[i].id % 2 === 0) { evens.push(arr[i].id); }
}
console.log(evens);
// [12, 14]

// ==== Challenge 1 ====
// The dealer can't recall the information for a car 
//with an id of 33 on his lot. Help the dealer find out which 
//car has an id of 33 by logging the car's year, make, and model 
...
// ==== Challenge 2 ====
// The dealer needs the information on the last car in their 
//inventory.  What is the make and model of the last car in the
...
// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on
// the website. Sort all the car model names into alphabetical order 
...
//  for(let i = 0; i < inventory.length; i++){
//   console.log(inventory.car_model[i].sort());
...
//   console.log();
// ==== Challenge 4 ====
// The accounting team needs all the years from every
// car on the lot. Create a new array from the dealer data
// containing only the car years and log the result in the console.
let carYears = [];
for(let i = 0; i < inventory.length; i++){
  if(inventory[i].car_year >= 1983){
